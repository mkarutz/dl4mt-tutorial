...
def main(model, model_options, dictionary_lm, dictionary_tm,
    ...
    # reload parameters
    print('Loading language model..', end=' ')
    params = load_params(model)
    tparams = init_tparams(params)
    print('Done')

    print('Loading LM dictionary..', end=' ')
    word_dict_lm = load_dictionary(dictionary_lm)
    print('Done')

    print('Loading TM dictionary..', end=' ')
    ...
    tm2lm_idx = {}
    for idx, word in list(word_idict_tm.items()):
