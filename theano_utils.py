'''
Utility functions for building models with Theano.
'''
import warnings
...
def init_tparams(params):
    ...
    for kk, pp in params.items():
        tparams[kk] = theano.shared(pp, name=kk)
    return tparams
...
def fflayer(tparams, state_below, options, prefix='rconv', activ='tanh', **kwargs):
    return eval(activ)(
